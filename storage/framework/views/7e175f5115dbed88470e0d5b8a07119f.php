      ...
      <div class="row gx-5">
        ...
        <main class="col-lg-6">
          <div class="ps-lg-3">
              ...
              <div class="col-12 mb-3">
                ...
                <div class="input-group mb-3" style="width: 170px;">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control text-center border border-secondary" id="quantityInput" placeholder="0" aria-label="Example text with button addon" aria-describedby="button-addon1" />                    <button class="btn btn-white border border-secondary px-3" type="button" id="button-addon2" data-mdb-ripple-color="dark" onclick="increment()">
            ...
            <a href="#" class="btn btn-primary shadow-0" data-id="<?php echo e($data->id); ?>"> <i class="me-1 fa fa-shopping-basket"></i> Add to cart </a>
...
<?php echo $__env->make("template.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-2\resources\views/product.blade.php ENDPATH**/ ?>